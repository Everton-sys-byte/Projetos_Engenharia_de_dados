...
with DAG(
    dag_id = 'primeira_dag_versao_2', default_args = default_args, description = 'Minha primeira dag mas na versão dois', 
    ...
    task3 = BashOperator(task_id='terceira_task', bash_command= "echo 'Olá, sou a terceira tarefa'")
